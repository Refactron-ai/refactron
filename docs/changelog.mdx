...
<Update label="0.4.6" description="September 7, 2026">
  **Security: a coverage-based `SAFE` on an untrusted diff was forgeable, and the
  ...
  `UNPROVEN`. Also hardened: coverage-driver isolation (ADR-17), an
  excluded-statement floor (ADR-18), and stronger credential redaction to the
  verified suite (value-shape matching; closes GHSA-7gr9-rqqx-xg6m, ADR-20).
